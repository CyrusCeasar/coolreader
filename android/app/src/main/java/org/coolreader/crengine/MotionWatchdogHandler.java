    ...
    public void handleMessage(Message msg) {
        ...
        switch (msg.what) {
            case MSG_MOTION_DETECTED:
                Toast.makeText(mCoolReader, "Got motion", Toast.LENGTH_SHORT).show();
                mIsStopping = false;
            ...
            case MSG_MOTION_TIMEOUT:
                mIsStopping = true;
                Toast.makeText(mCoolReader, "Timeout motion", Toast.LENGTH_SHORT).show();
                handleStop();
                break;
            case MSG_HANDLE_STOP_STEP:
                if (mIsStopping) {
                    Toast.makeText(mCoolReader, "Stop step", Toast.LENGTH_SHORT).show();
                    handleStop();
                }
                break;
        }
